---
title: "Compare SPCC 1.0 & 2.0v1 Refined Smoothed Segments - Future - St. Lucie County"
output:
  html_document:
    df_print: paged
editor_options:
...
ref_area <- st_read("K:\\Projects\\D4_CSHnetwork\\Features\\LU\\SPCC_20\\spcc_v20_final\\inputs\\StLucie.gdb",
          layer = "RefArea", quiet = TRUE) #reference area (for clipping segments and plcc layer)

layername <- "smoothed_segments_compare_stlucie"

gdb <- "K:\\Projects\\D4_CSHnetwork\\Features\\LU\\SPCC_20\\spcc_v0_final\\outputs\\future\\v20final_SegmentSmoothing.gdb"
