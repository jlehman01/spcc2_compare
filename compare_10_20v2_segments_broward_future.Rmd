---
title: "Compare SPCC 1.0 & 2.0v2 Refined Smoothed Segments - Future - Broward County"
output:
  html_document:
    df_print: paged
editor_options:
...
The table below provides a tabular comparison of SPCC refined smoothed analytic versions 1.0 to 2.0v2c. The rows represent linear feet of each classification under SPCC 1.0, and the columns represent liner feet per classification under SPCC 2.0v2.
