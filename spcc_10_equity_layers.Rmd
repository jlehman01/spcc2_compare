...
spcc10 <- st_read("K:/Projects/D4_CSHnetwork/Features/LU/SPCC/SPCC_V1_0_Final_w_metadata/Outputs/Districtwide_Refined_ver_1_0.gdb", layer = "Existing_RefinedSmoothedSegs_ver_1_0") %>% 
  st_transform(epsg) %>% 
  st_zm()
