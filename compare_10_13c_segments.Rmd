...
spcc_palette1 <- c("#267300", '#D7C29E', "#FFFFD4", "#F5EE1C", "#E60000", "#730000", "#0084A8")
...
spcc_palette2 <- c("#267300", '#D7C29E', "#FFFFD4", "#F5EE1C", "#E60000", "#730000", "#0084A8")
...
plcc_spcc_intersection %>%
  ...
  mutate(class_13c = str_remove_all(class_13c, " "),
         ...
         class_13c_plcc_alignment = if_else(class_13c == PLCC, "yes", "no"),
         linear_feet = as.numeric(st_length(.))) %>% 
  st_drop_geometry() %>% 
  kbl(col.names = c("SPCC 1.3c", "SPCC 1.0", "PLCC", "SPCC 1.3c - PLCC Alignment", "Linear Feet")) %>% 
  kable_paper("hover", full_width = F)
