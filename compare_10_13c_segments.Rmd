...
spcc_palette1 <- c("#267300", '#D7C29E', "#FFFFD4", "#F5EE1C", "#E60000", "#730000")
...
map2 <- tm_shape(segments) + tm_lines(col = "class_13c", lwd = 2.5, palette = spcc_palette2, title.col = "SPCC 1.3c Refined Smoothed", showNA = F) + tm_basemap("Esri.WorldImagery")
