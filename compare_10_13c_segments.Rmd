...
plcc_spcc <- st_read("K:/Projects/D4_CSHnetwork/Features/Transp/FDOT/D4_SPCC_PLCC_Tracking/PLCC_SPCC_080520_Revised_Route_Events.shp") %>% 
  st_zm() %>% 
  st_make_valid() %>% 
...
tm_shape(plcc_spcc_intersection) + tm_lines(lwd = 2.5)
```
