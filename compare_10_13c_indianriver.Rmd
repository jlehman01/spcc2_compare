---
title: "Compare SPCC 1.0 & 1.3c - Indian River County"
output:
  html_document:
    df_print: paged
editor_options:
...
spcc13c_gdb <- 'K:\\Projects\\D4_CSHnetwork\\Features\\LU\\SPCC_20\\spcc_v2_13b\\outputs\\existing\\Version_13c_full_D4_IndianRiver.gdb'
...
crosstab %>% 
  ...
  add_header_above(c("SPCC 1.0" = 1, "SPCC 1.3c" = ncol(crosstab)))
```
...
spcc13c_intden_gdb <- paste0(spcc13c_input_gdb, "\\intsect_den")
