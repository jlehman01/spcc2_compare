...
Version 1.3f uses a new approach to differentiating C-1 and C-2. To quality as C-1, a grid cell must now must have density-diversity-design characteristics below a C-3 AND have some level protection as a park or open space.
...
### Underlying Protected Areas in SPCC 1.3f
