---
title: "Compare SPCC 1.0 & 1.3d Refined Smoothed Segments - Future - Martin County"
output:
  html_document:
    df_print: paged
editor_options:
...
ref_area <- st_read("K:\\Projects\\D4_CSHnetwork\\Features\\LU\\SPCC_20\\spcc_v2_13b\\inputs\\Martin.gdb",
          layer = "RefArea", quiet = TRUE) #reference area (for clipping segments and plcc layer)

layername <- "smoothed_segments_martin_overlay"
...
plcc <- readRDS("K:\\Projects\\D4_CSHnetwork\\Features\\LU\\SPCC_20\\compare\\spcc2_compare\\data\\plcc.Rds") %>%    dplyr::select(SPCC, PLCC, FM_Num) %>% 
   ms_clip(ref_area) %>% 
